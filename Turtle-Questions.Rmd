...
### 8
Compute the dominant eigenvalue $\lambda$ and additionally express it as $r$, the intrinsic rate of increase. How do you value compare to those reported by the authors? If your values differ, what do you think could be the reason?
