...
### 18
Watch the [*this*](https://www.youtube.com/watch?v=hIJvSymWsCc) and [*this*](https://videos.fisheries.noaa.gov/detail/video/6046994059001/reducing-bycatch-helps-restore-sea-turtle-populations?autoStart=true&q=bycatch) video on turtle excluder devices.

### Submit your answers

1) Submit your analysis and answers to the questions as HTML document produced with *Rmarkdown*. The aim is that your work is **reproducible**, that is, every reader can see exactly how you obtained your answers and is able to repeat your analysis based on the submitted document.
