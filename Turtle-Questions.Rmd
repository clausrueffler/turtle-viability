...
### 6
Plot the population dynamics for a sufficiently long time until the time series stops fluctuating. Present this plot both with densities on the y-axis and with log-densities on the y-axis. Use $\mathbf N(0)=(30, 25, 10, 5, 5, 2, 1)^\mathrm{T}$ as a vector of initial population densities. How long does the transient dynamics (during which the population fluctuates) roughly last?
...
1) Submit your answers by Wednesday, 24:00, at the latest.

2) Submit your analysis and answers to the questions as an *Rmarkdown* document. The aim is that any of your scientific colleagues can see exacty how you obtained your answers and is able to repeat your analysis based on the submitted document

2) For the life cycle graph, it might be easiest if you make a photo or a scan of a drawing of the life cycle graph and include it as a figure file using the code from the [Rmarkdown tutorial](https://clausrueffler.github.io/CodingWithR/Markdown.html).